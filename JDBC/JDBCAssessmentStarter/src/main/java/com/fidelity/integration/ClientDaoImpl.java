...
public class ClientDaoImpl implements ClientDao {
	...
	public List<Client> getClients() {
		String sql = "SELECT c.client_id, c.client_name, c.client_risk, COALESCE(p.phone_number, 'N/A') phone_number FROM aa_client c LEFT JOIN aa_client_phone p ON c.client_id = p.client_id ORDER BY c.client_id, c.client_name";
