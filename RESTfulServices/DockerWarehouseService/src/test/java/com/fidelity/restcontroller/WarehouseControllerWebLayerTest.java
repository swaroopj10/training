...
public class WarehouseControllerWebLayerTest {
	...
	public void testAddWidgetToWarehouse() throws Exception {
		...
		when(service.addWidget(widget)).thenReturn(1);
	...
	public void testUpdateWidgetInWarehouse() throws Exception{
		...
		when(service.modifyWidget(widget)).thenReturn(1);
	...
	public void testAddGadgetToWarehouse() throws Exception {
		Gadget widget = new Gadget(42, "Two Cylinder Gadget", 19.99, 2);
		
		when(service.addGadget(widget)).thenReturn(1);
	...
	public void testUpdateGadgetInWarehouse() throws Exception{
		Gadget widget = new Gadget(1, "Two Cylinder Gadget", 19.99, 2);
		
		when(service.modifyGadget(widget)).thenReturn(1);
